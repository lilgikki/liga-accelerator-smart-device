...
/*!************************!*\
  !*** ./js/acardion.js ***!
  \************************/
/*! exports provided: activateSitePages, activateLocation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "activateSitePages", function() { return activateSitePages; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "activateLocation", function() { return activateLocation; });
var sitePages = document.getElementById('site-pages');
var sitePagesToggle = document.getElementById('site-pages-button');
var location = document.getElementById('location');
var locationToggle = document.getElementById('location-button');
if (sitePages) {
...
var openSitePages = function openSitePages() {
  sitePages.classList.remove('site-pages--close');
  sitePages.classList.add('site-pages--open');
};
var closeSitePages = function closeSitePages() {
...
var closeLocation = function closeLocation() {
  location.classList.add('location--close');
  location.classList.remove('location--open');
};
var clickSitePages = function clickSitePages() {
...
var clickLocation = function clickLocation() {
...
var activateSitePages = function activateSitePages() {
  if (sitePages) {
    sitePagesToggle.addEventListener('click', clickSitePages);
  }
};
var activateLocation = function activateLocation() {
  if (location) {
...
/*!********************!*\
  !*** ./js/form.js ***!
  \********************/
/*! exports provided: submitFormCallback, submitFormFeedback */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "submitFormCallback", function() { return submitFormCallback; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "submitFormFeedback", function() { return submitFormFeedback; });
var callbackPopup = document.getElementById('callback');
var formCallback = document.getElementById('callback-form');
var formFeedback = document.getElementById('feedback-form');
var nameCallback = document.getElementById('name-modal');
var nameFeedback = document.getElementById('name');
var phoneCallback = document.getElementById('tel-modal');
var phoneFeedback = document.getElementById('tel');
var submitForm = function submitForm(name, tel) {
  localStorage.setItem('username', name);
  localStorage.setItem('phone', tel);
};
var submitFormCallback = function submitFormCallback() {
  if (formCallback) {
    formCallback.addEventListener('submit', function (evt) {
...
var submitFormFeedback = function submitFormFeedback() {
  if (formFeedback) {
...
/* harmony import */ var _acardion_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./acardion.js */ "./js/acardion.js");
/* harmony import */ var _show_par_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./show-par.js */ "./js/show-par.js");
/* harmony import */ var _form_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./form.js */ "./js/form.js");
/* harmony import */ var _scroll_to_form_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./scroll-to-form.js */ "./js/scroll-to-form.js");
/* harmony import */ var _popup_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./popup.js */ "./js/popup.js");
/* harmony import */ var _mask_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./mask.js */ "./js/mask.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_acardion_js__WEBPACK_IMPORTED_MODULE_1__["activateSitePages"])();
  Object(_acardion_js__WEBPACK_IMPORTED_MODULE_1__["activateLocation"])();
  Object(_show_par_js__WEBPACK_IMPORTED_MODULE_2__["clickAboutButton"])();
  Object(_show_par_js__WEBPACK_IMPORTED_MODULE_2__["setParsTextContent"])();
  Object(_show_par_js__WEBPACK_IMPORTED_MODULE_2__["changeParsTextContent"])();
  Object(_form_js__WEBPACK_IMPORTED_MODULE_3__["submitFormCallback"])();
  Object(_form_js__WEBPACK_IMPORTED_MODULE_3__["submitFormFeedback"])();
  Object(_scroll_to_form_js__WEBPACK_IMPORTED_MODULE_4__["scrollToForm"])();
  Object(_popup_js__WEBPACK_IMPORTED_MODULE_5__["getPopup"])();
  Object(_mask_js__WEBPACK_IMPORTED_MODULE_6__["getMask"])();
...
var callbacklTel = document.getElementById('tel-modal');
...
var getMask = function getMask() {
  if (callbacklTel) {
    Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(callbacklTel, maskOptions);
  }
  if (feedbacklTel) {
...
var nameInput = document.getElementById('name-modal');
...
/*!************************!*\
  !*** ./js/show-par.js ***!
  \************************/
/*! exports provided: clickAboutButton, changeParsTextContent, setParsTextContent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "clickAboutButton", function() { return clickAboutButton; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "changeParsTextContent", function() { return changeParsTextContent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setParsTextContent", function() { return setParsTextContent; });
var MAX_MOBILE_WIDTH = 767;
var SECOND_PAR_TEXT = 'Наши поставщики - мировые производители электронных компонентов: OSRAM, CREE, HOLGLITRONIC, REFOND. ';
var THIRD_PAR_TEXT = 'Печатные платы и комплектующие Service Devices применяются на предприятиях Российских Железных Дорог (РЖД), РоссАвтоПрома (ВАЗ, АвтоГАЗ), МинАтома, СпецМедТехники. Среди наших клиентов крупнейшие Производители светотехники России.';
var FOURTH_PAR_TEXT = 'Smart Device - это команда профессионалов. Через нас прошло более 1 000 000 клиентов, 70% из которых продолжают сотрудничество по сей день. На данный момент насчитывается более 14 офисов по всей стране и 20 городов присутствия.';
var aboutBlock = document.querySelector('.about__block--hidden');
var aboutButton = document.querySelector('.about__button');
var secondPar = document.getElementById('par-2');
var fourthPar = document.getElementById('par-4');
var screenWidth;
if (aboutBlock) {
  aboutBlock.classList.remove('about__block--no-js');
}
var setParsTextContent = function setParsTextContent() {
  if (aboutBlock) {
...
var openBlock = function openBlock() {
...
var clickAboutButton = function clickAboutButton() {
  if (aboutBlock) {
...
var changeParsTextContent = function changeParsTextContent() {
  if (aboutBlock) {
